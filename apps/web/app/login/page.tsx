            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-5">
                ...
                <input
                  ...
                  required
                  className="w-full bg-bg border border-border rounded-sm text-sm text-text-primary placeholder:text-text-muted focus:placeholder:text-transparent focus:outline-none focus:border-accent transition-colors py-3 px-3.5"
                />
              </div>
