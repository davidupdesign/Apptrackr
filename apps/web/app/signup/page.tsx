            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: "20px" }}>
                ...
                <input
                  ...
                  placeholder="David K."
                  required
                  className="w-full bg-bg border border-border rounded-sm text-sm text-text-primary placeholder:text-text-muted focus:outline-none focus:border-accent transition-colors"
